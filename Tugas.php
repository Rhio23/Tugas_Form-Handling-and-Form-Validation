...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["email"])) {
    ...
    $email_Default "rhiorobby@gmail.com" ;
  } else {
  ...
  if (empty($_POST["alamat"])) {
    ...
    $alamat_Default = "JL.Pegenjahan RT 25 RW 04 desa Adiwerna Kec Adiwerna Kab Tegal";
  } else {
  ...
  if (empty($_POST["noHp"])) {
    ...
    if (empty($_POST["prodi"])) {
      ...
      $prodi_Default = "D4 Teknik Informatika"
    } else {
